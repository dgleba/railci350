...
RSpec.describe "ci_reviews/new", type: :view do
  before(:each) do
    assign(:ci_review, CiReview.new(
  ...
  it "renders new ci_review form" do
    render

    assert_select "form[action=?][method=?]", ci_reviews_path, "post" do
